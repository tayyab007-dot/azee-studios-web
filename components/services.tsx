...
const services = [
  {
    ...
    icon: Monitor,
    image: "/services/web and app dev.webp",
  ...
  },
  {
    ...
    icon: Gamepad2,
    image: "/services/3d and game dev.webp",
  ...
  },
  {
    ...
    icon: Palette,
    image: "/services/visual and brand identity.webp",
  ...
  },
  {
    ...
    icon: Video,
    image: "/services/vedio and media.webp",
