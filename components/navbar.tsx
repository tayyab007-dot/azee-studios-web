      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[999] bg-background/30 backdrop-blur-3xl text-foreground flex flex-col p-6 pb-28 lg:hidden w-screen h-[100vh] overflow-y-auto overscroll-contain"
          >
