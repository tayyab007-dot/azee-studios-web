...
function LazyNicheVideo({ url, className }: { url: string; className: string }) {
...
export function Niches() {
  return (
    <section id="niches" className="pt-12 pb-12 relative overflow-hidden">
        ...
        <div className="mt-4 flex flex-col md:flex-row items-start md:items-center justify-between bg-card/50 p-8 rounded-3xl border border-border/50 gap-6 md:gap-0">
          <div className="flex items-start gap-5">
            <div className="flex items-center justify-center flex-shrink-0 mt-1">
              <img src="/logo.webp" alt="Azee Studios" className="h-8 md:h-10 w-auto" />
            </div>
          ...
          <div className="text-left md:text-right flex flex-col items-start md:items-end w-full md:w-auto">
            <p className="text-sm font-medium">We Create <span className="text-accent">Visual Stories</span> That Connect.</p>
          </div>
        </div>
      </div>
    </section>
